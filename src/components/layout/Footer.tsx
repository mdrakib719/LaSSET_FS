        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link to="/people" className="text-gray-400 hover:text-white">
                  People
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              {/* <li><Link to="/resources" className="text-gray-400 hover:text-white">Educational Materials</Link></li>
              <li><Link to="/opportunities" className="text-gray-400 hover:text-white">Opportunities</Link></li>
              <li><Link to="/partners" className="text-gray-400 hover:text-white">For Partners</Link></li>
